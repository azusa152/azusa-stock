...
- **匯率曝險監控 (Currency Exposure Monitor)** — 雙分頁檢視（💵 現金幣別曝險 / 📊 全資產幣別曝險），可直接在 Step 4 切換本幣。現金分頁聚焦流動性資產的匯率風險，全資產分頁涵蓋完整投資組合。偵測近 5 日顯著匯率變動（>3%），甜甜圈圖視覺化，Telegram 警報含現金曝險金額
...
- **匯率曝險引擎** — 分離現金/全資產幣別分佈，偵測顯著匯率變動，Telegram 警報強調現金部位影響
